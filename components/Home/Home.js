    ...
    return(
        <SafeAreaView style={styles.conteiner}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={styles.progressStatusTittle}>
                    Weekly progress
                </Text>
                <Text style={styles.progressStatusText}>
                    On average, you practiced mindfulness{"\n"} <Text style={{fontWeight:"700"}}>4%</Text> more this week compared to last.
                </Text>
                ...
                <View>
                 ...
                 >
                    ...
                    >
                        ...
                        <Text style={[styles.progressText,{fontSize:10}]}>This week</Text>
                    </View>
                 </View>
                 <ProgressBar progress={0.9} color="#BBBBBB" style={{backgroundColor: '#565656', height:8, borderRadius: 4}} />
                </View>
                <View
                    style={{
                        paddingTop:27
